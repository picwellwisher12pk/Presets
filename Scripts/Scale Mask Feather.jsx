...
// ------------------------------ //
// 
// A Photoshop script to scale all Mask Feathering by a user defined scale, where 1.0 = 100%.
// By David Jensen.
// 
...
#target photoshop
app.bringToFront();
response=prompt("Mask feather scale factor",0.5)
if (response!=null){
...
function setVMF(featherSize){
    try{
        if(featherSize>1000)featherSize=1000;    
